...
public class ModItemGroup {
    ...
    public static final ItemGroup MOREBLOCKS = FabricItemGroupBuilder.build(
            new Identifier(TheMoreTheBetter.MOD_ID,"themoreblocks"), () -> new ItemStack(ModBlocks.RED_DIAMOND_BLOCK));
}
